...
Int64Decoder = _ModifiedDecoder(wire_format.WIRETYPE_VARINT, _DecodeSignedVarint64, wire_format.Int64Decoder)

UInt32Decoder = _SimpleDecoder(wire_format.WIRETYPE_VARINT, _DecodeVarint32)
--UInt64Decoder = _SimpleDecoder(wire_format.WIRETYPE_VARINT, _DecodeVarint64)
UInt64Decoder = _ModifiedDecoder(wire_format.WIRETYPE_VARINT, _DecodeVarint64, wire_format.Uint64Decoder)

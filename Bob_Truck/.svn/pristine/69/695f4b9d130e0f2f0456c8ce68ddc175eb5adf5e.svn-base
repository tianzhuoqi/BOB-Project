...
public class UIInputWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("submitOnUnselect", get_submitOnUnselect, set_submitOnUnselect);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_submitOnUnselect(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIInput obj = (UIInput)o;
			bool ret = obj.submitOnUnselect;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index submitOnUnselect on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_submitOnUnselect(IntPtr L)
	{
		object o = null;

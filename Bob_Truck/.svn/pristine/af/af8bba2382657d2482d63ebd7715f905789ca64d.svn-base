...
public class UILabelWrap
{
	...
	static int ProcessText(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				...
				obj.ProcessText(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UILabel.ProcessText");
			}
		}
		catch (Exception e)
		{
	...
	static int get_quadsPerCharacter(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index quadsPerCharacter on a nil value");
		}
	}

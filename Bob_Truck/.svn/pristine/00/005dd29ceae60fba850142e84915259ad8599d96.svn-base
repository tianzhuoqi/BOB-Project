...
{
	public Transform m_parentPanel;

    public string m_notificationKey;
...
#region Common functionality
	...
	public virtual void StartDragging ()
	{
		...
		if (!mDragging)
		{
			if (cloneOnDrag)
			{
                ...
                {
                    clone.transform.parent = m_parentPanel;
                }
	...
	protected virtual void OnDragDropRelease (GameObject surface)
	{
        ...
        NLuaUIWidgetBase luaUIWidget = surface.GetComponentInParent<NLuaUIWidgetBase>();
        if (luaUIWidget != null)
        {
            luaUIWidget.OnDropUp(m_index, m_notificationKey);
        }

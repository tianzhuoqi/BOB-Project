local FittingPanelBinder = class("FittingPanelBinder");

function FittingPanelBinder:ctor(gameObject)
	...
	self.m_Label_PeopleEfficiency = transform:Find("UI_Pos/Anchor_Middle/PanelProduct/m_Sprite_PeopleBG/m_Label_PeopleEfficiency"):GetComponent("UILabel");
	...
	self.m_Sprite_PeopleSign = transform:Find("UI_Pos/Anchor_Middle/PanelProduct/m_Sprite_PeopleBG/m_GameObject_People/m_Sprite_PeopleSign"):GetComponent("UISprite");

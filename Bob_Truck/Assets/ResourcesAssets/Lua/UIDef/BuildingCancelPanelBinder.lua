local BuildingCancelPanelBinder = class("BuildingCancelPanelBinder");

function BuildingCancelPanelBinder:ctor(gameObject)
	...
	self.m_btnCancel = transform:Find("Anchor_Center/m_btnCancel"):GetComponent("UIButton");
	self.m_Label_Dismantle = transform:Find("Anchor_Center/m_btnCancel/m_Label_Dismantle"):GetComponent("UILabel");
end
return BuildingCancelPanelBinder
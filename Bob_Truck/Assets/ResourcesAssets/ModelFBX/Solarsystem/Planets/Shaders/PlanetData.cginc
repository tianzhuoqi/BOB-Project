...
uniform sampler2D _SurfaceNormalMap2;
uniform sampler2D _DetailNormalMap;
uniform sampler2D _OceanMask;
uniform sampler2D _OceanMask2;
...
uniform float _OceanMask2U;
uniform float _OceanMask2V;
uniform float _HeightMap2U;
uniform float _SurfaceNormalMap2U;

uniform float _BackLightFactor;
uniform float4 _WaterColor;
uniform float _WaterColorMult;
struct PlanetInput
{

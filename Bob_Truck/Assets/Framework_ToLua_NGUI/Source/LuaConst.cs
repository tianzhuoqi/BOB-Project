...
{
    public static string luaDir = Application.dataPath + "/ResourcesAssets/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Framework_ToLua_NGUI/ToLua/Lua";        //tolua lua文件目录
    ...
    public static bool openLuaDebugger = false;          //是否连接lua调试器ZbsDebugger

#if RELEASE         
    public static bool openLuaVSCodeDebugger = false;    //是否连接lua调试器VSCode
#else
    public static bool openLuaVSCodeDebugger = true;
#endif
}
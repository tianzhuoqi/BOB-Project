...
public class UIPanelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("useSortingOrder", get_useSortingOrder, set_useSortingOrder);
	...
	static int get_generateUV2(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index generateUV2 on a nil value");
		}
	}
	...
	static int get_onCreateMaterial(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onCreateMaterial on a nil value");
		}
	}
	...
	static int set_onCreateMaterial(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIPanel.OnCreateMaterial arg0 = (UIPanel.OnCreateMaterial)ToLua.CheckDelegate<UIPanel.OnCreateMaterial>(L, 2);
